...
class SAlertContent extends React.Component {
    ...
    render() {
        ...
        const alertElemWrapperRef = this.currentAlertElemWrapper;

        return React.createElement(contentTemplate, {alertElemWrapperRef, classNames, id, styles, message, handleClose, customFields, condition});
    }
}
